...
import '../styles/SleepTrackerPage.scss';
    ...
    <div className="sleep-tracker-page">
      <div className="min-h-screen text-white flex flex-col justify-between">
        <div className="p-6">
          ...
          {/* Circle Progress Clock */}
          <div
            className="relative w-60 h-60 mx-auto rounded-full mb-10"
            style={{
              background: "conic-gradient(#fac105 0% 75%, #4f46e5 75% 100%)"
            }}
          >
            {/* Inner Circle */}
