    ...
    <div className="min-h-screen bg-[#0B0E24] text-white flex flex-col justify-between">
      <div className="p-6">
        ...
        <div className="relative w-60 h-60 mx-auto rounded-full mb-10"
          style={{ background: `conic-gradient(#facc15 0% 75%, #4f46e5 75% 100%)` }}>
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-52 h-52 bg-[#0B0E24] rounded-full"></div>
          </div>
          <div className="absolute top-[5%] left-1/2 transform -translate-x-1/2 text-sm">12AM</div>
          <div className="absolute bottom-[5%] left-1/2 transform -translate-x-1/2 text-sm">12PM</div>
          <div className="absolute left-[5%] top-1/2 transform -translate-y-1/2 text-sm">6PM</div>
          <div className="absolute right-[5%] top-1/2 transform -translate-y-1/2 text-sm">6AM</div>
        </div>
      ...
      <div className="px-6 mb-20">
        <button className="w-full py-4 rounded-full bg-white text-blue-900 font-bold text-lg shadow-md">
          Sleep Now
        </button>
      </div>
