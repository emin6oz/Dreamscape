...
export default function Sleep4() {
  ...
  const options = ["Well rested", "Not bad", "Average", "Barely sleep", "More tired than before sleep"];

  return (
    <div className="min-h-screen bg-[#070B26] text-white flex flex-col justify-between p-6 relative">
      <BackButton />
      <div>
        <h1 className="text-xl font-bold text-center mb-8">Do you wake up feeling well rested?</h1>
