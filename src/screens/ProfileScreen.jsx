...
const ProfileScreen = () => {
  ...
  // if (!checked) return <p className="text-white p-6">Checking session...</p>;
    ...
    <div className="min-h-screen bg-[#0A0F24] text-white flex flex-col justify-between">
      <div className="p-6">
        ...
        <div className="bg-[#131735] rounded-2xl p-4 mb-8 grid grid-cols-2 gap-4">
          <ChallengeCircle
            percentage={50}
            label="You listened calming sounds 5/10 days in a row"
          />
          <ChallengeCircle
            percentage={90}
            label="You tracked your sleep 9/10 days in a row"
          />
        </div>
        ...
        <div className="bg-[#131735] rounded-2xl p-4 space-y-4 text-base">
          ...
          <div
            ...
            className="pt-2 text-red-400 font-semibold cursor-pointer"
          >
            Log out
          </div>
        </div>
